...
hData =...[ 10.714305725	
    ...
    14.4014983755	20.8225447327	21.2024074872...
         ...
         42.9133041668	42.8508770934	43.8660779761	42.5763929893	44.1947934168	40.8353794651];
...
N_push  = a(3).*exp(-a(2).*(1-a(3)).*T); % out due to pushing
N_slide = (1-exp(-a(2).*(1-a(3)).*T)); % out due to sliding
N_total = N_push+N_slide; % total out of IDR
% N  = (exp(-a(2).*T))+(1-T);
R  = (1+a(4)*(N_total));%+(a(4))*T);
D  = 100*((R-1)./R +N_push./R );
H  = 100*(D./100+((N_slide)./R));
