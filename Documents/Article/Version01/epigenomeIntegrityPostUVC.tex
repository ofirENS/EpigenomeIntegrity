...
\section{Introduction}\label{section:Introduction}
	 % damages caused by UV can be determental to cell survival
	 
	 % dNA repair is known to operate through several mechanisms
	 
	 % in the process of repair the epigenomic content is being disrupted
	 
	 % it is not clear how the cell retains epigenomic imprinting post DNA damage 
	 
	 % our hypothesis is chromatin remodling and nucleosome sliding operates post UVC
	 
	 % at the end of repair, nucleosomes are being repositioned into their approximate iitial location
	 
	 % thus the epigenomic memory is not lost and does not need to be resyntesized 
	 
	 % large scale remodeling are being put back to place by functional equilibrium 
