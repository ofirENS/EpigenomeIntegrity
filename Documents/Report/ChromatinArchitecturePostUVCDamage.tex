...
\begin{document}
	...
	\begin{figure}[H]
	\includegraphics[width=0.5\linewidth]{RadiusOfExpansion500BeadsAffectedLennardJonesCrosslinked}
	\includegraphics[width=0.5\linewidth]{RadiusOfExpansion500BeadsNonAffectedLennardJonesCrosslinked}
	...
	We now examine the radius of expansion for the process described above.
