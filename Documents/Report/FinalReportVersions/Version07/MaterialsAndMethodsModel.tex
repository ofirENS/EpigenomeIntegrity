...
\begin{document}	
 ...
 \section{Material and methods: Modeling nucleosomes and DNA redistribution following UV damages} 
	...
	The rate at which nucleosomes are extruded from the DR by pushing is comprised of 
	
	\begin{equation}\label{eq:nucleosomePushRate}
    \frac{dN_P(u)}{du}=k_p\left((c_nA_0-N(u))-k_s(c_nA_0-N_S(u))\right)\frac{dT(u)}{du}
	\end{equation}
